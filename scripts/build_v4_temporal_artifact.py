"""Build the standard two-window temporal viz from a VIZ_STANDARD JSON payload."""
...
DATA_PATH = Path("outputs/v4_temporal_data.json")
...
def main() -> None:
    ...
    ap.add_argument("--data", default=str(DATA_PATH),
                    help="VIZ_STANDARD JSON payload (default: v4 temporal data)")
    ...
    model_name = str(meta.get("model") or payload[order[0]].get("model", "clot_gnn_v4"))
