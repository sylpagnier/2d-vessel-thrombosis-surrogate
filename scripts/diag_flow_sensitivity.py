...
from scripts.eval_clot_ml_v0 import PACKS, _times  # noqa: E402
...
from src.clot_ml.v0 import load_v0_bundle, predict_clot_ml_v0, solve_fem_into_pack  # noqa: E402
...
def score_at(bundle_base, bundle_v0, data, times, bio, phys, flow):
    ...
    last = times[-1]
    wall, off = eval_domains(S)          # domains come from the SAMPLE, as in eval_clot_ml_v0
