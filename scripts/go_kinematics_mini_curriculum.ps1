...
$targetScript = Join-Path $PSScriptRoot "go_kinematics_production_allfix.ps1"
& $targetScript -Fresh -Epochs 40 -AdamEpochs 35 -Stage1End 15 -Stage2End 30 -GraphCap 1000 -Holdout $Holdout
exit $LASTEXITCODE
