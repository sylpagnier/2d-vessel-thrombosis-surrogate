...
def main() -> None:
    ...
    ap.add_argument("--nonwound", default="outputs/clot_ml_0_oof_temporal_data.json")
    ap.add_argument("--wound", default="outputs/clot_ml_0_wound_temporal_data.json")
    ap.add_argument("--out", default="outputs/clot_ml_0_temporal_data.json")
    args = ap.parse_args()
