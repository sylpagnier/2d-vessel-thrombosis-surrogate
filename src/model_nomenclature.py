"""Canonical SciML model identifiers for 2D Thrombosis Surrogate (2d-thrombosis-surrogate).
...
PROJECT_ID = "2d-thrombosis-surrogate"
PROJECT_DISPLAY_NAME = "2D Thrombosis Surrogate"
