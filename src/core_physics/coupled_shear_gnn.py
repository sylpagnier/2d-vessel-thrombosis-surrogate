...
**Archived reference** -- import via ``src.core_physics.coupled_shear_gnn`` shim (legacy biochem path).
"""
...
def assemble_local_corrector_features(
    ...
    positions by the geometric length scale (``d_bar`` on COMSOL anchor graphs, channel
