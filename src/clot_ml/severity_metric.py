"""`SeverityScorer` / `severity_components` -- a burden-aware replacement for the flat relaxed deploy score.
...
the shipped `tau_abs = 15`, `rho = 0.25` (the values docs/publication/STORY.md 0.3 quotes):

    n_gt =  15, found 10  ->  tau_eff =  3.75  ->  recall_eff = 10/11.25 = 0.889
    n_gt = 150, found 100 ->  tau_eff = 15.00  ->  recall_eff = 100/135  = 0.741
