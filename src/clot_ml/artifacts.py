...
always supposed to mean.
    ...
    shipped(UNIFIED)     # -> "clot_ml_final_0"   whatever is currently promoted
    shipped(WOUND)       # -> "clot_ml_final_w"   derived from its manifest chain
    shipped(BASE)        # -> "clot_ml_final"
