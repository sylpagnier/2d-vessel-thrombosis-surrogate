"""Tests for canonical SciML model nomenclature (2D Thrombosis Surrogate)."""
...
def test_project_branding() -> None:
    assert PROJECT_ID == "2d-thrombosis-surrogate"
    assert PROJECT_DISPLAY_NAME == "2D Thrombosis Surrogate"
