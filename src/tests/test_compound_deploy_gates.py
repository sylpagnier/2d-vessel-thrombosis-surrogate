...
def test_idle_spray_allows_paint_with_good_precision():
    per = {"comsol002": _row(deploy_clot_offwall_n_gt_hop_ge2=0.0, deploy_clot_offwall_n_pred_hop_ge2=5.0)}
    ok, reason = idle_spray_ok(per, "comsol002")
    assert ok
...
def test_idle_spray_fails_on_precision_collapse():
    ...
    ok, _ = idle_spray_ok(per, "comsol002")
    assert not ok


def test_gate_compound_target_hit():
    per = {
        "comsol001": _row(deploy_clot_offwall_n_pred_hop_ge2=30.0, deploy_clot_offwall_n_gt_hop_ge2=50.0),
        "comsol007": _row(deploy_clot_offwall_n_pred_hop_ge2=20.0, deploy_clot_offwall_n_gt_hop_ge2=40.0),
        "comsol002": _row(deploy_clot_offwall_n_gt_hop_ge2=0.0, deploy_clot_offwall_n_pred_hop_ge2=0.0),
        "comsol004": _row(deploy_clot_offwall_n_gt_hop_ge2=0.0, deploy_clot_offwall_n_pred_hop_ge2=0.0),
        "comsol008": _row(deploy_clot_offwall_n_gt_hop_ge2=0.0, deploy_clot_offwall_n_pred_hop_ge2=0.0),
    }
