...
def test_v0_is_the_base_gnn_on_a_nowound_pack():
    ...
    # `clot_ml_v0` (retired 2026-09-07) was the last resort here; there is no further fallback
    # now, so an unresolvable pointer just skips like any other absent-artifact checkout.
