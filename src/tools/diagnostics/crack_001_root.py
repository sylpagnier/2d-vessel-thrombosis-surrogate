...
from src.evaluation.deploy_ckpt_recipe import (  # noqa: E402
    apply_deploy_ckpt_recipe as _apply_ckpt_recipe,
    load_eval_static as _load_static,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if (
        ...
        report["root_cause_candidates"].append(
            "On the correct EVAL static, compound still opens 007 but not 001 ΓÇö "
    ...
    if (
        ...
        report["root_cause_candidates"].append(
            "Growth-alone also fails to form clot/lumen on 001 ΓÇö specialist cannot "
